...
dest_folder = f"./data/W1-labeling-results/{exec_timestamp}"
...
def parse_args(args):
    ...
    generated_exec_plans_folders = [
        "./data/W1/cloud-7_generated_jobs_exec_plans/1GB",
        "./data/W1/cloud-7_generated_jobs_exec_plans/5GB",
        "./data/W1/cloud-7_generated_jobs_exec_plans/10GB",
        "./data/W1/cloud-7_generated_jobs_exec_plans/50GB"
    ]

    generated_jobs_info_path = "./data/W1/generated_jobs/generated_jobs_info.json"
    ...
    jobs_task_manager_details = [
        "./data/W1/cloud-7_generated_jobs_task_manager_details/1GB",
        "./data/W1/cloud-7_generated_jobs_task_manager_details/5GB",
        "./data/W1/cloud-7_generated_jobs_task_manager_details/10GB",
        "./data/W1/cloud-7_generated_jobs_task_manager_details/50GB"
    ]
